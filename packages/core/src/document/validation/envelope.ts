...
export function validateEnvelope(doc: unknown): OmmValidationIssue[] {
  ...
  if (!doc || typeof doc !== "object") {
    issues.push({ path: "", message: "Document must be an object", code: "envelope.missing" });
    return issues;
  }
  ...
  if (!d.paper || typeof d.paper !== "object") {
    issues.push({ path: "paper", message: `"paper" must be an object`, code: "envelope.missing_paper" });
  }
  ...
  if (!d.layout || typeof d.layout !== "object") {
    issues.push({ path: "layout", message: `"layout" must be an object`, code: "envelope.missing_layout" });
  }

  // assets must be an object
  if (!d.assets || typeof d.assets !== "object") {
    issues.push({ path: "assets", message: `"assets" must be an object`, code: "envelope.missing_assets" });
  }

  // meta must be an object
  if (!d.meta || typeof d.meta !== "object") {
    issues.push({ path: "meta", message: `"meta" must be an object`, code: "envelope.missing_meta" });
  }
